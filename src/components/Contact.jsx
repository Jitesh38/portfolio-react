...
function Contact() {
  return (
    <>
      <div className="min-h-screen w-full snap-start " id="contact">
        ...
        <div className="w-[50%] m-auto mt-5 md:mt-10 flex justify-around gap-6">
          <a
            href="https://www.linkedin.com/in/jitesh-prajapati/"
            target="_blank"
          >
            <FontAwesomeIcon
              icon={faLinkedin}
        ...
        <div className="flex flex-col md:flex-row justify-center items-center md:items-start m-5 p-10 gap-8">
          <div className="">
        ...
        {/* Footer */}
        {/* <div className="bg-gray-900 h-[50px] text-white">
